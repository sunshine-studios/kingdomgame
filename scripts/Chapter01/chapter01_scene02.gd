...
@export var json_file_path: String = "res://jsons/Chapter01_Scene02.json"
@export var scene_dialogue_sequence: Array[String] = ["player_0", "kingdoma_0", "kingdomb_01", "kingdomc_01"]
